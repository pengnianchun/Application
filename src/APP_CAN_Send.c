...
void BCAN_test_0x552(void) {
    ...
    msg.data[4] = ADV[5] / 20;
    msg.data[5] = ADV[6] / 20;
    msg.data[6] = Can1TestMode + ((unsigned char) Can2TestMode << 1);
    msg.data[7] = 0;
    msg.id = 0x552;
    msg.len = 0x08;
    msg.type = 0x01;
...
void BCAN_test_0x553(void) {
    CAN_MESSAGE msg;
    msg.data[0] = alarm_led[1].byte;
    msg.data[1] = alarm_led[2].byte;
    msg.data[2] = alarm_led[3].byte;
    msg.data[3] = (OC1RS > 0) && 0x3F;
    msg.data[4] = 0;
    msg.data[5] = 0;
    msg.data[6] = 0;
    msg.data[7] = 30;
...
void PCAN_0x18F43A17(void) {
    ...
    if (ADV[4] < 500)
        ...
        temp = (unsigned int) ((ADV[4] - 500) / 33.33);
    msg.data[0] = temp;   
    //电压型传感器
    if (ADV[3] < 500)
        temp = 0;
        ...
        temp = (unsigned int) ((ADV[3] - 500) / 33.33);
    msg.data[1] = temp;
    msg.data[2] = 0;
    msg.data[3] = 0; 
    CAN_DATA.bit1 = 0; 
    ...
    CAN_DATA.bit5 = 0;
    CAN_DATA.bit6 = rKL15;
    CAN_DATA.bit7 = (LED1 || LED2); 
    CAN_DATA.bit8 = (CAN_0x0CF100D0.Warning2.double2 > 0);
    msg.data[4] = CAN_DATA.byte;        
    msg.data[5] = 0;  
    msg.data[6] = 0;
    msg.data[7] = Life++;
...
void PCAN_0x18F43B17(void) {
    ...
    temp = e_total_miles;
    msg.data[0] = (unsigned char) (temp); //低八位
    msg.data[1] = (unsigned char) (temp >> 8); //二级八位
    msg.data[2] = (unsigned char) (temp >> 16); //三级八位
    msg.data[3] = (unsigned char) (temp >> 24); //高八位
    CAN_DATA.bit1 = 0; 
    CAN_DATA.bit2 = 0; 
    CAN_DATA.bit3 = 0; 
    CAN_DATA.bit4 = 0;
